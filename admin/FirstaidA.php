...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaida(a_name, a_desc, image) VALUES('$a_name', '$a_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Firstaid Name" name="a_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="a_desc" ></textarea>
