...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidf(f_name, f_desc, image) VALUES('$f_name', '$f_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Firstaid Name" name="f_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="f_desc" ></textarea>
