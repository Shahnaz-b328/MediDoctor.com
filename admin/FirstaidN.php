...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidn(n_name, n_desc, image) VALUES('$n_name', '$n_desc', '$uploaded_image')";
		...
		?>     
			<h2>FirstAid</h2>
			<button class="but success"><a href="firstaid_insertN.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<label>FirstAid Name</label>
			<input type="text" placeholder="Enter Firstaid Name" name="n_name">
