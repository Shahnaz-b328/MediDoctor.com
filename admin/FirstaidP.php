...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidp(p_name, p_desc, image) VALUES('$p_name', '$p_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Firstaid Name" name="p_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="p_desc" ></textarea>
