...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidq(q_name, q_desc, image) VALUES('$q_name', '$q_desc', '$uploaded_image')";
		...
		?>     <h2>FirstAid</h2>
			...
			<input type="text" placeholder="Enter Firstaid Name" name="q_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="q_desc" ></textarea>
