...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaids(s_name, s_desc, image) VALUES('$s_name', '$s_desc', '$uploaded_image')";
		...
		?>     <h2>FirstAid</h2>
			...
			<input type="text" placeholder="Enter Firstaid Name" name="s_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="s_desc" ></textarea>
