...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidt(t_name, t_desc, image) VALUES('$t_name', '$t_desc', '$uploaded_image')";
		...
		?>     <h2>FirstAid</h2>
			...
			<input type="text" placeholder="Enter Firstaid Name" name="t_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="t_desc" ></textarea>
