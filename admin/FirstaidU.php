...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidu(u_name, u_desc, image) VALUES('$u_name', '$u_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Firstaid Name" name="u_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="u_desc" ></textarea>
