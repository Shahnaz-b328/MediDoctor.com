...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO firstaidv(v_name, v_desc, image) VALUES('$v_name', '$v_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Firstaid Name" name="v_name">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="v_desc" ></textarea>
