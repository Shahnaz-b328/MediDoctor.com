...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO alzheimer(alzheimer_name, alzheimer_desc, image) VALUES('$alzheimer_name', '$alzheimer_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Disease Name" name="alzheimer_name">
			...
			<label>Disease Desc</label>
              ...
              <textarea class="tinymce" name="alzheimer_desc" ></textarea>
