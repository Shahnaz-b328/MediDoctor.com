...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from alzheimer order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['alzheimer_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['alzheimer_desc']); ?></td>
				<td>
				<a href="alzheimer_edit.php?alzheimer_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="alzheimer_dele.php?alzheimer_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
