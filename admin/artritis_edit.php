...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['artritis_editid']) || $_GET['artritis_editid'] == NULL) {
			echo "<script>window.location = 'artritis_insert.php';</script>";
			} else {
				$postid = $_GET['artritis_editid'];
				}
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "UPDATE artritis
					  SET
					  artritis_name = '$artritis_name',
					  artritis_desc = '$artritis_desc',
		...
		?>    
			...
			$query = "select * from artritis where id='$postid' order by id";
			...
			<input type="text" name="artritis_name" value="<?php echo $result['artritis_name']; ?>">
			...
			<label>Disease Desc</label>
              ...
              <textarea class="tinymce" name="artritis_desc" >
			  <?php echo $result['artritis_desc']; ?>
			  </textarea>
