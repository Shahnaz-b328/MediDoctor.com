...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from artritis order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['artritis_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['artritis_desc']); ?></td>
				<td>
				<a href="artritis_edit.php?artritis_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="artritis_dele.php?artritis_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
