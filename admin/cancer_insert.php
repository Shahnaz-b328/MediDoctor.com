...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from cancer order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['cancer_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['cancer_desc']); ?></td>
				<td>
				<a href="cancer_edit.php?cancer_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="cancer_dele.php?cancer_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
