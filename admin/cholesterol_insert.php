...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from cholesterol order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['cholesterol_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['cholesterol_desc']); ?></td>
				<td>
				<a href="cholesterol_edit.php?cholesterol_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="cholesterol_dele.php?cholesterol_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
