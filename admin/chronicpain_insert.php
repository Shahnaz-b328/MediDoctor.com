...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from chronicpain order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['chronicpain_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['chronicpain_desc']); ?></td>
				<td>
				<a href="chronicpain_edit.php?chronicpain_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="chronicpain_dele.php?chronicpain_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
