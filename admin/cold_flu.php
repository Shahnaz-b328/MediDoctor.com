...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO cold(cold_name, cold_desc, image) VALUES('$cold_name', '$cold_desc', '$uploaded_image')";
		...
		?>     
			...
			<input type="text" placeholder="Enter Disease Name" name="cold_name">
			...
			<label>Disease Desc</label>
              ...
              <textarea class="tinymce" name="cold_desc" ></textarea>
