...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from cold order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['cold_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['cold_desc']); ?></td>
				<td>
				<a href="cold_edit.php?cold_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="cold_dele.php?cold_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
