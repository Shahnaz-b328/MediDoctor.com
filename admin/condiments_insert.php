...
<body>
			...
			<tr>
				...
				<th>Image</th>
				<th>Condiments Description</th>
				<th>Action</th>
			</tr>
				<?php 
				$query = "select * from condiments order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['c_desc']); ?></td>
				<td>
				<a href="condiments_edit.php?condiments_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="condiments_dele.php?condiments_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
