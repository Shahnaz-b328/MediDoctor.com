...
<body>
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['disease_desc']); ?></td>
				<td>
				<a href="edit_disease.php?edit_diseaseid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_disease.php?dele_diseaseid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
