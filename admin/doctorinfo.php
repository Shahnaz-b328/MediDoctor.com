...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from doc order by id";
			...
			<tr>
				...
				<td><?php echo $result['doc_info']; ?></td>
				<td><a href="doc_edit.php?doc_editid=<?php echo $result['id']; ?>">Edit</a> 
					||
				<a onclick="return confirm('Are you sure to Delete')" href="doc_dele.php?doc_deleid=<?php echo $result['id']; ?>">Delete</a></td>
