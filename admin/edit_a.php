...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_aid']) || $_GET['edit_aid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertA.php';</script>";
			} else {
				$postid = $_GET['edit_aid'];
				}
		...
		$a_desc = mysqli_real_escape_string($db->link, $_POST['a_desc']);
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertA.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaida where id='$postid' order by id";
			...
			<input type="text" name="a_name" value="<?php echo $result['a_name']; ?>">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="a_desc" >
			  <?php echo $result['a_desc']; ?>
			  </textarea>
