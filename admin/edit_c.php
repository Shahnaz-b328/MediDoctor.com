...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_cid']) || $_GET['edit_cid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertC.php';</script>";
			} else {
				$postid = $_GET['edit_cid'];
				}
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertC.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaidc where id='$postid' order by id";
