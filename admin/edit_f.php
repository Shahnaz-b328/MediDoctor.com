...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_fid']) || $_GET['edit_fid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertF.php';</script>";
			} else {
				$postid = $_GET['edit_fid'];
				}
		...
		$f_desc = mysqli_real_escape_string($db->link, $_POST['f_desc']);
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertF.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaidf where id='$postid' order by id";
			...
			<input type="text" name="f_name" value="<?php echo $result['f_name']; ?>">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="f_desc" >
			  <?php echo $result['f_desc']; ?>
			  </textarea>
