...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_gid']) || $_GET['edit_gid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertG.php';</script>";
			} else {
				$postid = $_GET['edit_gid'];
				}
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertG.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaidg where id='$postid' order by id";
			...
			<input type="text" name="g_name" value="<?php echo $result['g_name']; ?>">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="g_desc" >
			  <?php echo $result['g_desc']; ?>
			  </textarea>
