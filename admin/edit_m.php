...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_mid']) || $_GET['edit_mid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertM.php';</script>";
			} else {
				$postid = $_GET['edit_mid'];
				}
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertM.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaidm where id='$postid' order by id";
			...
			<input type="text" name="m_name" value="<?php echo $result['m_name']; ?>">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="m_desc" >
			  <?php echo $result['m_desc']; ?>
			  </textarea>
