...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_pid']) || $_GET['edit_pid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertP.php';</script>";
			} else {
				$postid = $_GET['edit_pid'];
				}
		...
		$p_desc = mysqli_real_escape_string($db->link, $_POST['p_desc']);
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertP.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaidp where id='$postid' order by id";
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="p_desc" >
