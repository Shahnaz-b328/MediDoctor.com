...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['edit_uid']) || $_GET['edit_uid'] == NULL) {
			echo "<script>window.location = 'firstaid_insertU.php';</script>";
			} else {
				$postid = $_GET['edit_uid'];
				}
		...
		$u_desc = mysqli_real_escape_string($db->link, $_POST['u_desc']);
		...
		?>    
			<h2>Update</h2>
			<button class="but success"><a href="firstaid_insertU.php">Inserted Data</a></button>
			<form action="#" method="post" enctype="multipart/form-data">	
			<?php 
			
			$query = "select * from firstaidu where id='$postid' order by id";
			...
			<input type="text" name="u_name" value="<?php echo $result['u_name']; ?>">
			...
			<label>FirstAid Desc</label>
              ...
              <textarea class="tinymce" name="u_desc" >
			  <?php echo $result['u_desc']; ?>
			  </textarea>
