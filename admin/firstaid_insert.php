...
<body>
			...
			<nav>
                <ul>
				<li><a href="index.php">Deshborad</a></li>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaid order by id_no desc";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['firstaid_name']; ?></td>
				<td>Abdominal Pain</td>
				<td><?php echo $result['firstaid_desc']; ?></td>
				<td><a href="firstaid.php">Edit</a> || <a href="">Delete</a></td>
			</tr>
			<?php }} ?>
				</table>
				</div>
