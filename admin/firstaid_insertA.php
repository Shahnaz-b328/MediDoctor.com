...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaida order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['a_desc']); ?></td>
				<td>
				<a href="edit_a.php?edit_aid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_a.php?dele_aid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
