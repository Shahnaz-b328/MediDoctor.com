...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidb order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['b_desc']); ?></td>
				<td><a href="edit_b.php?edit_bid=<?php echo $result['id']; ?>">Edit</a> 
				|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_b.php?dele_bid=<?php echo $result['id']; ?>">Delete</a></td>
			</tr>
			<?php }} ?>
				</table>
				</div>
