...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaide order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['e_desc']); ?></td>
				<td>
				<a href="edit_e.php?edit_eid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_e.php?dele_eid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
