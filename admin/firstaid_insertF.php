...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidf order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['f_desc']); ?></td>
				<td>
				<a href="edit_f.php?edit_fid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_f.php?dele_fid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
