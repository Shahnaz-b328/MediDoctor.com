...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidi order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['i_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['i_desc']); ?></td>
				<td>
				<a href="edit_i.php?edit_iid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_i.php?dele_iid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
