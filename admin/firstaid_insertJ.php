...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidj order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['j_desc']); ?></td>
				<td>
				<a href="edit_j.php?edit_jid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_j.php?dele_jid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
