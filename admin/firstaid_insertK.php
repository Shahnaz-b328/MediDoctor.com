...
<body>
			...
			<tr>
				...
				<th>FirstAid Name</th>
				<th>Image</th>
				<th>FirstAid Description</th>
				<th>Action</th>
			</tr>
				<?php 
				$query = "select * from firstaidk order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['k_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['k_desc']); ?></td>
				<td>
				<a href="edit_k.php?edit_kid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_k.php?dele_kid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
