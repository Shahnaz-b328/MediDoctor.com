...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidl order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['l_desc']); ?></td>
				<td>
				<a href="edit_l.php?edit_lid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_l.php?dele_lid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
