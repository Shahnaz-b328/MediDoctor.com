...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidm order by id";
			...
			<tr>
				...
				<td>
				<a href="edit_m.php?edit_mid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_m.php?dele_mid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
