...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidn order by id";
			...
			<tr>
				...
				<td>
				<a href="edit_n.php?edit_nid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_n.php?dele_nid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
