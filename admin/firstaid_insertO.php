...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaido order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['o_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['o_desc']); ?></td>
				<td>
				<a href="edit_o.php?edit_oid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_o.php?dele_oid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
