...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidp order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['p_desc']); ?></td>
				<td>
				<a href="edit_p.php?edit_pid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_p.php?dele_pid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
