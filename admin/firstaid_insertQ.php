...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidq order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['q_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['q_desc']); ?></td>
				<td>
				<a href="edit_q.php?edit_qid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_q.php?dele_qid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
