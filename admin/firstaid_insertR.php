...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidr order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['r_desc']); ?></td>
				<td>
				<a href="edit_r.php?edit_rid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_r.php?dele_rid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
