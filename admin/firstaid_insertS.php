...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaids order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['s_desc']); ?></td>
				<td>
				<a href="edit_s.php?edit_sid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_s.php?dele_sid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
