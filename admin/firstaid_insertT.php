...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidt order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['t_desc']); ?></td>
				<td>
				<a href="edit_t.php?edit_tid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_t.php?dele_tid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
