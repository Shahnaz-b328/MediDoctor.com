...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidu order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['u_desc']); ?></td>
				<td>
				<a href="edit_u.php?edit_uid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_u.php?dele_uid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
