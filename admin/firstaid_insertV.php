...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidv order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['v_desc']); ?></td>
				<td>
				<a href="edit_v.php?edit_vid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_v.php?dele_vid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
