...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidw order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['w_desc']); ?></td>
				<td>
				<a href="edit_w.php?edit_wid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_w.php?dele_wid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
