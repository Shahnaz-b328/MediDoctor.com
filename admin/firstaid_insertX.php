...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidx order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['x_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['x_desc']); ?></td>
				<td>
				<a href="edit_x.php?edit_xid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_x.php?dele_xid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
