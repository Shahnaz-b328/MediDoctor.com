...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidy order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['y_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['y_desc']); ?></td>
				<td>
				<a href="edit_y.php?edit_yid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_y.php?dele_yid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
