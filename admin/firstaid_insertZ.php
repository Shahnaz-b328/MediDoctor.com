...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from firstaidz order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['z_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['z_desc']); ?></td>
				<td>
				<a href="edit_z.php?edit_zid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="dele_z.php?dele_zid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
