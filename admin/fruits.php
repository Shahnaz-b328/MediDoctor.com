...
<body>
		...
		echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
			...
			$query = "INSERT INTO fruits(fruit_name, fruit_desc, image) VALUES('$fruit_name', '$fruit_desc', '$uploaded_image')";
		...
		?>     <h2>Fruits</h2>
			...
			<input type="text" placeholder="Enter Fruit Name" name="fruit_name">
			...
			<label>Fruit Desc</label>
              ...
              <textarea class="tinymce" name="fruit_desc" ></textarea>
