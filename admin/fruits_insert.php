...
<body>
			...
			<tr>
				...
				<?php 
				$query = "select * from fruits order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['fruit_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['fruit_desc']); ?></td>
				<td>
				<a href="fruit_edit.php?fruit_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="fruit_dele.php?fruit_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
