...
<body>
		...
		<div class="container">
			...
			if (!isset($_GET['grains_editid']) || $_GET['grains_editid'] == NULL) {
			echo "<script>window.location = 'grains_insert.php';</script>";
			} else {
				$postid = $_GET['grains_editid'];
				}
		...
		?>    
			...
			$query = "select * from grains where id='$postid' order by id";
