...
<body>
			...
			<tr>
				<th>Id</th>
				<th>Herbs and Spices Name</th>
				<th>Image</th>
				<th>Herbs and Spices Description</th>
				<th>Action</th>
			</tr>
				<?php 
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['h_desc']); ?></td>
				<td>
				<a href="herbs_edit.php?herbs_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="herbs_dele.php?herbs_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
