...
<body>
			...
			<tr>
				<th>Id</th>
				<th>Meats and Seafoods Name</th>
				<th>Image</th>
				<th>Meats and Seafoods Description</th>
				<th>Action</th>
			</tr>
				<?php 
				$query = "select * from meats order by id";
			...
			<tr>
				...
				<td><?php echo $fm->textShorten($result['m_desc']); ?></td>
				<td>
				<a href="meats_edit.php?meats_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="meats_dele.php?meats_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
