...
<body>
			...
			<tr>
				<th>Id</th>
				<th>Nuts and Seeds Name</th>
				<th>Image</th>
				<th>Nuts and Seeds Description</th>
				<th>Action</th>
			</tr>
				<?php 
				$query = "select * from nuts order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['n_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['n_desc']); ?></td>
				<td>
				<a href="nuts_edit.php?nuts_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="nuts_dele.php?nuts_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
