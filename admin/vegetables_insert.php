...
<body>
			...
			<tr>
				...
				<th>Image</th>
				<th>Vegetables Description</th>
				<th>Action</th>
			</tr>
				<?php 
				$query = "select * from vegetable order by id";
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo $result['vege_name']; ?></td>
				<td><img src="<?php echo $result['image']; ?>" height="100px" width="200px"/></td>
				<td><?php echo $fm->textShorten($result['vege_desc']); ?></td>
				<td>
				<a href="vegetables_edit.php?vegetables_editid=<?php echo $result['id']; ?>">Edit</a> 
					|| 
				<a onclick="return confirm('Are you sure to Delete')" href="vegetables_dele.php?vegetables_deleid=<?php echo $result['id']; ?>">Delete</a>
				</td>
			</tr>
			<?php }} ?>
				</table>
