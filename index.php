...
<body>
	<header>
		...
		<ul>  
      			<li class="active"><a href="../MediDoctor.com/index.php">Home</a></li>
				...
				<li><a href="../MediDoctor.com/blog.php">Our Blog</a></li>
         		...
         		<li><a href="../MediDoctor.com/register.php">Registration</a></li>
      		</ul>
			...
			<div class="flex-items2">
				...
				<div class="title-line margin-top"></div>
					<div class="para">
						...
						find the neutrition value of your food here.Come join us. <a href="../MediDoctor.com/register.php">.... Register Now</p></a>
					</div>
			</div>
	 	</div>
	 </div>
  ...
  <div class="main">
    ...
    <div class="col-md-2">
      <div class="inner">
        ...
        <a href="../MediDoctor.com/fst_register.php"><h6>Dental Specialist</h6>
    ...
    <div class="col-md-2">
      <div class="inner">
        <!-- <img src="../MediDoctor.com/image/8.jpg"> -->
        <a href="../MediDoctor.com/register.php"><h6>Pediatric Specialist</h6>
    ...
    <div class="col-md-2">
      <div class="inner">
        <!-- <img src="../MediDoctor.com/image/8.jpg"> -->
        <a href="../MediDoctor.com/register.php"><h6>Gynecology and obstractics</h6>
      ...
      <div class="inner">
        ...
        <a href="../MediDoctor.com/register.php"><h6>Medicine Specialist</h6>
...
<section class="who-we-are">
	<div class="main">
		<div class="heading">
			<a href="../MediDoctor.com/register.php"><h2>First Aid</h2></a>
			<p>First Aid option is here for you.You can browse Your problems here. Check Now! </p>
		</div>

		<div class="col-1">
			<div class="text-box">
				<a href="../MediDoctor.com/register.php"><h4>Animal Bites</h4>
		...
		<div class="col-1">
			<div class="text-box">
				<a href="../MediDoctor.com/register.php"><h4>Abdominal Pain of Children</h4>
		...
		<div class="col-1">
			<div class="text-box">
				<a href="../MediDoctor.com/register.php"><h4>Abdominal Pain</h4>
...
<section class="our-portfolio">
	<div class="main">
		<div class="heading">
			<a href="../MediDoctor.com/register.php"><h2>Food Facts</h2></a>
			<p></p>
			</div>
      ...
      <div class="first-hover">
        ...
        <div class="overlay-text">
          <h3><a href="../MediDoctor.com/register.php">Grains and Legumes</a></h3>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="first-hover">
        ...
        <div class="overlay-text">
          <h3><a href="../MediDoctor.com/register.php">Condiments</a></h3>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="first-hover">
        ...
        <div class="overlay-text">
          <h3><a href="../MediDoctor.com/register.php">Meats and Seafoods</a></h3>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="first-hover">
        ...
        <div class="overlay-text">
          <h3><a href="../MediDoctor.com/register.php">Dairy/Dairy Alternatives</a></h3>
        </div>
      </div>
    </div>
...
<div class="dis-btn">
	<a href="../MediDoctor.com/register.php" class="btn">a</a>
	<a href="../MediDoctor.com/register.php" class="btn">b</a>
	<a href="../MediDoctor.com/register.php" class="btn">c</a>
	<a href="../MediDoctor.com/register.php" class="btn">d</a>
	<a href="../MediDoctor.com/register.php" class="btn">e</a>
	<a href="../MediDoctor.com/register.php" class="btn">f</a>
	<a href="../MediDoctor.com/register.php" class="btn">g</a>
	<a href="../MediDoctor.com/register.php" class="btn">h</a>
	<a href="../MediDoctor.com/register.php" class="btn">i</a>
	<a href="../MediDoctor.com/register.php" class="btn">j</a>
	<a href="../MediDoctor.com/register.php" class="btn">k</a>
	<a href="../MediDoctor.com/register.php" class="btn">l</a>
	<a href="../MediDoctor.com/register.php" class="btn">m</a>
	</div>
</section>
<section class="dictionary">
<div class="dis-btn">
	<a href="../MediDoctor.com/register.php" class="btn">n</a>
	<a href="../MediDoctor.com/register.php" class="btn">o</a>
	<a href="../MediDoctor.com/register.php" class="btn">p</a>
	<a href="../MediDoctor.com/register.php" class="btn">q</a>
	<a href="../MediDoctor.com/register.php" class="btn">r</a>
	<a href="../MediDoctor.com/register.php" class="btn">s</a>
	<a href="../MediDoctor.com/register.php" class="btn">t</a>
	<a href="../MediDoctor.com/register.php" class="btn">u</a>
	<a href="../MediDoctor.com/register.php" class="btn">v</a>
	<a href="../MediDoctor.com/register.php" class="btn">w</a>
	<a href="../MediDoctor.com/register.php" class="btn">x</a>
	<a href="../MediDoctor.com/register.php" class="btn">y</a>
	<a href="../MediDoctor.com/register.php" class="btn">z</a>
</div>
</section>       
		<!--***********************************************************-->
		<!--*************** Sec bgimg started ******************-->
	...
	<div class="main">
		<div class="text-box-2">
			...
			<h5>Video Corner is For you If you are Finding the solution for
				...
				this out. </h5>
			<a href="../MediDoctor.com/register.php">MORE DETAIL</a>
		</div>
...
<section class="who-we-are our-blog">
	<div class="main">
		<div class="heading">
			<<a href="../MediDoctor.com/register.php"><h2>OUR BLOG</h2></a>
			<p></p>
		</div>
		...
		<div class="col-1">
			...
			<div class="text-box">
			<a href="../MediDoctor.com/register.php">
		...
		<img src="../MediDoctor.com/image/blog/A (25).jpg" ></img>
         <div class="text-box">
        	<a href="../MediDoctor.com/register.php"><h4>5 Satvik Food Items That You Must Store In Your Kitchen</h4>
      ...
      <div class="text-box">
        <a href="../MediDoctor.com/register.php"><h4>The Psychological Effects of the Keto Diet </h4>
